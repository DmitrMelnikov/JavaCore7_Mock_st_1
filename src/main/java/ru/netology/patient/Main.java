...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String id1 = patientInfoRepository.add(
                new PatientInfo("Иван", "Петров15", LocalDate.of(1980, 11, 26),
                        new HealthInfo(new BigDecimal("39.65"), new BloodPressure(120, 80))));


        String id2 = patientInfoRepository.add(
                new PatientInfo("Семен", "Михайлов15", LocalDate.of(1982, 1, 16),
                        new HealthInfo(new BigDecimal("37.6"), new BloodPressure(125, 78)))
        );
